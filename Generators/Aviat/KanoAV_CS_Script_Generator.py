...
def Generate_KanoAV_CS_Script(CP_ID, ui):
    ...
    if not found_rows1:
        ...
        for index, row in enumerate(found_rows1, start=1):
            ...
            # naming the file
            file_name = f"ModProj_{sites_details1[2]}_Kano_CTR.txt"
            print(sites_details1[2])

            # Create a folder with the same name pattern as the file name
            folder_name = f"{CP_ID}_Kano_Aviat"
            ...
            with open(file_path, "w") as file:
                ...
                file.write(" route-target import 64910:104\n")
                file.write(" route-target export 64910:104\n")
                file.write(" exit\n")
                file.write("!\n")
                file.write("!\n")
    ...
    if not found_rows2:
        ...
        for index, row in enumerate(found_rows2, start=1):
            ...
            # naming the file
            file_name = f"ModProj_{sites_details2[2]}_Kano_CTR.txt"
    ...
    if not found_rows3:
        ...
        for index, row in enumerate(found_rows3, start=1):
            ...
            with open(file_path, "a") as file:
                ...
                file.write(f" net 49.4026.{result_rsvp_ip}.00\n")
                file.write(" exit\n")
                file.write("!\n")
                file.write("!\n")
