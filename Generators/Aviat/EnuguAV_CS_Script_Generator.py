...
def Generate_EnuguAV_CS_Script(CP_ID, ui):
    ...
    #             BASE_DIR,
    #             "..", "..",
    #             "Config", "AviatLLD", "EnuguLLD_AV", "av_eptp.xlsx"
    #         )
    #     )
    # )
    # worksheet1 = workbook1['av_eptp']
    ...
    #             BASE_DIR,
    #             "..", "..",
    #             "Config", "AviatLLD", "EnuguLLD_AV", "av_eslld.xlsx"
    #         )
    #     )
    # )
    # worksheet2 = workbook2['av_eslld']
    ...
    #             BASE_DIR,
    #             "..", "..",
    #             "Config", "AviatLLD", "EnuguLLD_AV", "sysip2023.xlsx"
    #         )
    #     )
    # )
    # worksheet3 = workbook3['sysip2023']
    ...
    if not found_rows1:
        ui.showNotification(f"❌ {CP_ID} not found in {worksheet1} EnuguAV LLD files.")
        return None
        ...
        for index, row in enumerate(found_rows1, start=1):
            ...
            # naming the file
            file_name = f"ModProj_{sites_details1[2]}_Enugu_CTR.txt"
            print(sites_details1[2])

            # Create a folder with the same name pattern as the file name
            folder_name = f"{CP_ID}_Enugu_Aviat"
    ...
    if not found_rows2:
        ...
        for index, row in enumerate(found_rows2, start=1):
            ...
            # naming the file
            file_name = f"ModProj_{sites_details2[2]}_Enugu_CTR.txt"
