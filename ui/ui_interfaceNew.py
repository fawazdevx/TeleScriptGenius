...
################################################################################
## Form generated from reading UI file 'interfaceNewtXftHR.ui'
##
...
"")
        ...
        sizePolicy12.setHeightForWidth(self.frame_23.sizePolicy().hasHeightForWidth())
        self.frame_23.setSizePolicy(sizePolicy12)
...
"}")
        ...
        sizePolicy14.setHeightForWidth(self.label_16.sizePolicy().hasHeightForWidth())
        self.label_16.setSizePolicy(sizePolicy14)
        font8 = QFont()
        ...
        self.regionBox = QComboBox(self.regionFrame)
...
"")
        ...
        self.tempBox = QComboBox(self.tempFrame)
...
"")
        ...
        sizePolicy15.setHeightForWidth(self.sitename.sizePolicy().hasHeightForWidth())
        self.sitename.setSizePolicy(sizePolicy15)
...
"")
        ...
        sizePolicy13.setHeightForWidth(self.generateBtn.sizePolicy().hasHeightForWidth())
        self.generateBtn.setSizePolicy(sizePolicy13)
...
"")
        ...
        sizePolicy16.setHeightForWidth(self.widget_5.sizePolicy().hasHeightForWidth())
        self.widget_5.setSizePolicy(sizePolicy16)
...
"}")
        ...
        sizePolicy11.setHeightForWidth(self.heroCard.sizePolicy().hasHeightForWidth())
        self.heroCard.setSizePolicy(sizePolicy11)
...
"")
        ...
        sizePolicy16.setHeightForWidth(self.frame_33.sizePolicy().hasHeightForWidth())
        self.frame_33.setSizePolicy(sizePolicy16)
        ...
        sizePolicy15.setHeightForWidth(self.frame_49.sizePolicy().hasHeightForWidth())
        self.frame_49.setSizePolicy(sizePolicy15)
...
"}")
        ...
        sizePolicy14.setHeightForWidth(self.label_58.sizePolicy().hasHeightForWidth())
        self.label_58.setSizePolicy(sizePolicy14)
        ...
        sizePolicy15.setHeightForWidth(self.frame_50.sizePolicy().hasHeightForWidth())
        self.frame_50.setSizePolicy(sizePolicy15)
...
"}")
        ...
        sizePolicy15.setHeightForWidth(self.frame_51.sizePolicy().hasHeightForWidth())
        self.frame_51.setSizePolicy(sizePolicy15)
...
"}")
        ...
        sizePolicy15.setHeightForWidth(self.frame_43.sizePolicy().hasHeightForWidth())
        self.frame_43.setSizePolicy(sizePolicy15)
